...
public enum NotifyTemplate {
  ...
  OUTGOING_OPERATOR_PROJECT_TRANSFER_V1("OUTGOING_OPERATOR_PROJECT_TRANSFER_V1"),
  INCOMING_OPERATOR_PROJECT_TRANSFER_V1("INCOMING_OPERATOR_PROJECT_TRANSFER_V1"),
