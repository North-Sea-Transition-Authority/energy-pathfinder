...
public class ProjectInformationFormValidator implements SmartValidator {
  ...
  public static final String OIL_AND_GAS_FIELD = "oilAndGasSubCategory";
  public static final String OIL_AND_GAS_MISSING_ERROR =
      String.format("Select an %s category", FieldStage.OIL_AND_GAS.getDisplayName().toLowerCase());
  ...
  private void validateFieldStage(ProjectInformationForm form,
    ...
    if (ValidationType.FULL.equals(projectInformationValidationHint.getValidationType())) {
      ...
      } else if (FieldStage.OIL_AND_GAS.equals(fieldStage)) {
        ValidationUtils.rejectIfEmptyOrWhitespace(
            errors,
            OIL_AND_GAS_FIELD,
            OIL_AND_GAS_FIELD.concat(".required"),
            OIL_AND_GAS_MISSING_ERROR
        );
    ...
    if (FieldStage.OIL_AND_GAS.equals(fieldStage) && FieldStageSubCategory.DEVELOPMENT.equals(oilAndGasSubCategory)) {
