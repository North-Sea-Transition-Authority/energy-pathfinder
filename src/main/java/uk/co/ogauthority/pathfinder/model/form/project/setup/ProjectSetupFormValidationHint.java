...
public final class ProjectSetupFormValidationHint {
  ...
  public static final String PLATFORMS_FPSOS_REQUIRED_TEXT = "Select yes if you plan to add any platforms or FPSOs to be decommissioned to your project";
  public static final String SUBSEA_INFRASTRUCTURE_REQUIRED_TEXT = "Select yes if you plan to add any subsea infrastructure to be decommissioned to your project";
