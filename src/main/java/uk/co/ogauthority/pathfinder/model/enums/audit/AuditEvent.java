...
public enum AuditEvent {
  ...
  SUBSCRIBER_DETAILS_UPDATED(AuditLevel.INFO, "Subscription details updated for subscriber with uuid: %s"),
  //Form page POSTS
  PROJECT_OPERATOR_UPDATED(AuditLevel.INFO, "Project operator/developer with id: %d updated for projectDetail with id: %d"),
  ...
  UPCOMING_TENDER_CONVERTED(AuditLevel.INFO, "Upcoming tender with id: %d converted to awarded contract for projectDetail with id: %d"),
  ...
  WORK_PLAN_UPCOMING_TENDER_CONVERTED(AuditLevel.INFO,
      "Work plan upcoming tender with id: %d converted to awarded contract for projectDetail with id: %d"),
