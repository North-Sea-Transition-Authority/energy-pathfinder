...
class QuarterlyUpdateInitialReminderScheduler {
  ...
  private static final String JOB_DOMAIN_PREFIX = "QUARTERLY_UPDATE_INITIAL_REMINDER";
  ...
  @Autowired
  QuarterlyUpdateInitialReminderScheduler(SchedulerService schedulerService) {
