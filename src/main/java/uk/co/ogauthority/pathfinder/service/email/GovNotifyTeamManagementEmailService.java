...
public class GovNotifyTeamManagementEmailService implements TeamManagementEmailService {
  ...
  @Autowired
  public GovNotifyTeamManagementEmailService(EmailService emailService,
