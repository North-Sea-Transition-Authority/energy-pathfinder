...
public class AnalyticsService {
  ...
  private void sendEvent(
    ...
    try {
      ...
      sendEventForTag(
          restTemplate,
          configurationProperties.getProperties().getAppTag(),
          configurationProperties.getConfig().getAppTagApiSecret(),
          clientId,
          eventCategory,
          paramMap
      );
      ...
      sendEventForTag(
          restTemplate,
          configurationProperties.getProperties().getGlobalTag(),
          configurationProperties.getConfig().getGlobalTagApiSecret(),
          clientId,
          eventCategory,
          paramMap
      );
