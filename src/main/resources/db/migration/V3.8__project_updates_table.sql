...
, CONSTRAINT proj_update_from_detail_fk FOREIGN KEY (from_project_detail_id) REFERENCES ${datasource.user}.project_details (id)
, CONSTRAINT proj_update_new_detail_fk FOREIGN KEY (new_project_detail_id) REFERENCES ${datasource.user}.project_details (id)
) TABLESPACE tbsdata;
