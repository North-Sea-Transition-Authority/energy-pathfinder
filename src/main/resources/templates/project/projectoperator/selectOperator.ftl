...
>
  <@fdsForm.htmlForm>
    <@fdsSearchSelector.searchSelectorRest
      path="form.operator"
      labelText="Who is the operator/developer for the project?"
      selectorMinInputLength=0
      restUrl=springUrl(operatorsRestUrl)
      preselectedItems=preselectedOperator!{}
    />

    <@fdsDetails.summaryDetails summaryTitle="The operator/developer I want to create a project for is not listed">
      <p class="govuk-body">
        If the operator/developer you need to create a project for is not shown in the list then you must contact
        the operator/developer to provide you with access to their organisation.
      </p>
    ...
    <@fdsRadio.radioGroup
      ...
      labelText="Is this the operator/developer you want shown on the ${customerSupplyChainInterfaceText}?"
      hiddenContent=true
    >
      ...
      <@fdsRadio.radioNo path=isPublishedAsOperatorFormBind>
        <@fdsSearchSelector.searchSelectorRest
          ...
          labelText="Which operator/developer do you want shown on the ${customerSupplyChainInterfaceText}?"
          selectorMinInputLength=0
