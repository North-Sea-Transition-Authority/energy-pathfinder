...
<@defaultPage htmlTitle="Location" pageHeading="Location" breadcrumbs=true >
    ...
    <@fdsForm.htmlForm>
      ...
      <@fdsTextInput.textInput path="form.waterDepth" labelText="What is the water depth?" inputClass="govuk-input--width-4" />
      <@fdsRadio.radioGroup path="form.approvedFieldDevelopmentPlan" labelText="Do you have an approved Field Development Plan (FDP)?" fieldsetHeadingClass="govuk-fieldset__legend" hiddenContent=true>
        <@fdsRadio.radioYes path="form.approvedFieldDevelopmentPlan">
          <@fdsNumberInput.twoNumberInputs pathOne="form.approvedFdpDate.month" pathTwo="form.approvedFdpDate.year" nestingPath="form.approvedFieldDevelopmentPlan" fieldsetHeadingClass="govuk-fieldset__legend" labelText="What is the FDP approved date?" formId="approvedFdpDate-month-year">
      ...
      <@fdsRadio.radioGroup path="form.approvedDecomProgram" labelText="Do you have an approved Decomissioning Program (DP)?" fieldsetHeadingClass="govuk-fieldset__legend" hiddenContent=true>
        <@fdsRadio.radioYes path="form.approvedDecomProgram">
          <@fdsNumberInput.twoNumberInputs pathOne="form.approvedDecomProgramDate.month" pathTwo="form.approvedDecomProgramDate.year" nestingPath="form.approvedDecomProgram" fieldsetHeadingClass="govuk-fieldset__legend" labelText="What is the DP approved date?" formId="approvedDecomProgramDate-month-year">
