      ...
      <div class="govuk-header__logo">
        <a href="${homePageUrl}" class="govuk-header__link govuk-header__link--homepage">
          <span class="govuk-header__logotype">
            <#if headerLogo == "GOVUK_CREST">
              <svg role="presentation" focusable="false" class="govuk-header__logotype-crown" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 132 97" height="30px" width="36px">
                <g id="g3111-1">
            ...
            <#else>
              <svg version="1.1" class="govuk-header__logotype-droplet" height="30" width="36" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 26.52 36" style="enable-background:new 0 0 26.52 36;" xml:space="preserve">
                <path fill="currentColor" class="st5" d="M16.05,0C14.34,0,0,7.84,0,21.93C0,29.34,5.98,36,13.39,36c7.41,0,13.42-6.01,13.42-13.42c0-6.43-5.55-10.31-7.2-12.08C14.02,4.49,16.05,0,16.05,0z"/>
              </svg>
            </#if>
...
<#macro headerNavigation navItems="" currentUser="">
  <button type="button" data-module="govuk-button" role="button" class="govuk-header__menu-button govuk-js-header-toggle" aria-controls="navigation" aria-label="Show or hide Top Level Navigation" id="expand-contract-menu-button">Menu</button>
  <nav title="Top level navigation">
    <ul id="navigation" class="govuk-header__navigation " aria-label="Top Level Navigation">
      <#--Use a list if the number of navigation items is unknown-->
      <#nested>
    </ul>
  </nav>
</#macro>