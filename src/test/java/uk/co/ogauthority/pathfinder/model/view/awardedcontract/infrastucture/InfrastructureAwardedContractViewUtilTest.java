package uk.co.ogauthority.pathfinder.model.view.awardedcontract.infrastucture;
...
class InfrastructureAwardedContractViewUtilTest {
  ...
  void awardedContractViewBuilder_withFromListFunction() {
    ...
    var awardedContractView = new InfrastructureAwardedContractViewUtil.InfrastructureAwardedContractViewBuilder(
        awardedContract,
        DISPLAY_ORDER,
  ...
  void awardedContractViewBuilder_containsCorrectSummaryLinks() {
    ...
    assertThat(summaryLinks).containsExactly(
        InfrastructureAwardedContractViewUtil.getEditLink(projectId, awardedContractId),
        InfrastructureAwardedContractViewUtil.getDeleteLink(projectId, awardedContractId, DISPLAY_ORDER)
    );
  }
