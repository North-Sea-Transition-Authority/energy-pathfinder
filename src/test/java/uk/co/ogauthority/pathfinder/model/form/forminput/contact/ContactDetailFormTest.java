...
import uk.co.ogauthority.pathfinder.testutil.ContactDetailsUtil;
...
public class ContactDetailFormTest {
  ...
  public void objectConstruction_whenContactDetailCapture_thenCorrectPopulation() {
    ...
    contactDetailEntity.setName(ContactDetailsUtil.CONTACT_NAME);
    contactDetailEntity.setJobTitle(ContactDetailsUtil.JOB_TITLE);
    contactDetailEntity.setPhoneNumber(ContactDetailsUtil.PHONE_NUMBER);
    contactDetailEntity.setEmailAddress(ContactDetailsUtil.EMAIL);
