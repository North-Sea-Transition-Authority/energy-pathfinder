package uk.co.ogauthority.pathfinder.architecture;
...
import uk.co.ogauthority.pathfinder.PathfinderApplication;
...
class ArchitectureTests {
  ...
  void displayableEnumsAreMaterialised() {
    var javaClasses = new ClassFileImporter()
        ...
        .importPackagesOf(PathfinderApplication.class);
