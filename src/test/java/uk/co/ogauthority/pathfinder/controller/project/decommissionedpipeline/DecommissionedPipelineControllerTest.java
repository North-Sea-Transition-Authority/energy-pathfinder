...
public class DecommissionedPipelineControllerTest extends ProjectContextAbstractControllerTest {
  ...
  // Pipelines disabled: PAT-457
  @Test
  public void getPipelines_whenAuthenticated_thenNotFound() throws Exception {
  ...
  @Test
  public void savePipelines_whenAuthenticated_thenNotFound() throws Exception {
    mockMvc.perform(
  ...
  @Test
  public void addPipeline_whenAuthenticated_thenNotFound() throws Exception {
    mockMvc.perform(get(ReverseRouter.route(
  ...
  @Test
  public void getPipeline_whenAuthenticated_thenNotFound() throws Exception {
    mockMvc.perform(get(ReverseRouter.route(
  ...
  @Test
  public void createPipeline_whenAuthenticated_thenNotFound() throws Exception {
  ...
  @Test
  public void updatePipeline_whenAuthenticated_thenNotFound() throws Exception {
    MultiValueMap<String, String> completeParams = new LinkedMultiValueMap<>() {{
      add(ValidationTypeArgumentResolver.COMPLETE, ValidationTypeArgumentResolver.COMPLETE);
    }};
  ...
  @Test
  public void removePipelineConfirmation_whenAuthenticated_thenNotFound() throws Exception {
    mockMvc.perform(get(ReverseRouter.route(
  ...
  @Test
  public void removePipeline_whenAuthenticated_thenNotFound() throws Exception {
    MultiValueMap<String, String> completeParams = new LinkedMultiValueMap<>() {{
      add(ValidationTypeArgumentResolver.COMPLETE, ValidationTypeArgumentResolver.COMPLETE);
    }};
