...
public class DecommissionedPipelineControllerTest extends ProjectContextAbstractControllerTest {
  ...
  public void setup() {
    ...
    when(decommissionedPipelineService.createDecommissionedPipeline(any(), any()))
        .thenReturn(DecommissionedPipelineTestUtil.createDecommissionedPipeline());
  }
  ...
  public void savePipelines_whenUnauthenticated_thenNoAccess() throws Exception {
    ...
    when(decommissionedPipelineSummaryService.getValidatedDecommissionedPipelineSummaryViews(projectDetail)).thenReturn(
  ...
  public void savePipelines_whenValid_thenRedirect() throws Exception {
    ...
    when(decommissionedPipelineSummaryService.getValidatedDecommissionedPipelineSummaryViews(projectDetail)).thenReturn(
        decommissionedPipelineViews);
    when(decommissionedPipelineSummaryService.validateViews(decommissionedPipelineViews)).thenReturn(
