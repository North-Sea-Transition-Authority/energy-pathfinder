...
public class StartProjectControllerTest extends AbstractControllerTest {
  ...
  public void redirect_whenSingleTeam() throws Exception {
    ...
    when(startProjectService.startProject(authenticatedUser, projectOperatorForm)).thenReturn(detail);
    ...
    verify(startProjectService, times(1)).startProject(authenticatedUser, projectOperatorForm);
  }
}
