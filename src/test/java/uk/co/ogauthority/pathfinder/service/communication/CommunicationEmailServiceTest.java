...
public class CommunicationEmailServiceTest {
  ...
  @Test
  public void sendCommunicationEmail_whenRecipients_verifyInteractions() {
    final var communication = CommunicationTestUtil.getCompleteCommunication();
    final var recipientList = List.of(
        new Recipient("someone@example.com", "Someone", "Example"),
        new Recipient("someone.else@example.com", "Someone", "Else")
    );
